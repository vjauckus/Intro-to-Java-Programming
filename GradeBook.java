...
public class GradeBook
{
     ...
     */
    public String getTeacherComment(int studentIndex)
    {
        // YOUR CODE HERE
        ...
        String[] comments=new String[numStudents];
        
        for(int student=0; student<numStudents; student++){
            
            double scoreSum=totalForStudent(student);
            String note="";
                if(scoreSum>30){
                
                    note="very good";
                }
                else if(scoreSum<15 && scoreSum>0){
                    note="bad";
                }
                else{
                    note="middle";
                }
                comments[student]=studentNames[student]+" scores sum: "+scoreSum+". Result: "+note;
            }
            
           // System.out.println(comments[student]);
        
        
        //String studentName = students.get(student);
         String comment=comments[studentIndex];
