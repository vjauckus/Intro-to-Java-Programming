...
public class PictureUtil
{
    ...
    public static Picture grayAndFlipLeftToRight( Picture pic)
    {
        ...
        //System.out.println("Picture's height and width after: "+pic.getHeight()+" "+pic.getWidth());
        //pic2.draw();
        return pic2;
    ...
    public static Picture grayAndRotate90( Picture pic)
    {
        ...
        // column of the new array
         int[][] pixels = pic.getGrayLevels();
          int[][] pixels_new = new int[pixels[0].length][pixels.length];
              ...
              for (int i = 0; i < pixels.length; i++) //rows
        {
            ...
            for (int j = 0; j < pixels[0].length; j++)
            {
                  ...
                  pixels_new[j][pixels.length-1-i]=pixels[i][j];
                
            }
            
        }
          Picture pic2 = new Picture(pixels_new);
        return pic2; //just so draft will compile. You will change it in the final
    }
