    ...
    */
    ...
    /**
       ...
       any passengers whose destination is that location.
        @return ArrayList of passengers that get dropped off (arrived)
    */
    // TODO: Return a list of all passengers that get dropped off
    public ArrayList<Person> drive()
    {
        //wird immer neu beim drive gemacht, deswegen hat keine Doppeleintr?ge 
        ArrayList<Person> inCarPeople = new ArrayList<Person>();
        location++;
